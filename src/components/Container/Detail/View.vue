<template>
  <div class="pb-10">
    <div class="py-2 bg-white">
      ...
      <IntroText :title="tip" :icon-name="['fas', 'calendar-check']" />
    </div>
    <div class="bg-white">
      <IntroCard title="详细介绍" :icon-name="['fas', 'list']" :content="intro" />
    </div>
    <div class="bg-white">
      <IntroCard title="购票信息" :icon-name="['fas', 'list']" :content="ticketInfo" />
    </div>
  </div>
</template>
